...
import { X, ArrowLeft, Search, CheckCircle2, Pencil, Trash2, Plus, Minus } from 'lucide-react'
import { mockCustomers, mockEmployees, mockBookings } from '../../mock/data'
          ...
          <>
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-800/30 border-t border-slate-200 dark:border-slate-800 shrink-0">
              <button onClick={() => {
                ...
                toast.success(`Đã hoàn tất ${actionText} tại ${selectedRoom.name} cho khách hàng: ${customer?.name}`)
